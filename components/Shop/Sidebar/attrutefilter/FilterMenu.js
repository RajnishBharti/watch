...
function FilterMenu({ attrData, updateData, closeAll }) {
        ...
        <div className={styles.menu}>
          ...
          {getToggle(i) ? (
            <div className={styles.subMenu}>
              <ul>
                {e.values.map((d, i) => (
                  <li onClick={() => setSelectedAttrData(e.name, d.value)}>
                    <span
                      className={
                        selectAttr[e.name]?.includes(d.value)
                          ? styles.active
                          : null
                      }
                    ></span>
