...
const Worldmark = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    date: '',
    time: '',
    subject: 'Worldmark store - New Query',
  });
  ...
  useEffect(() => {
    ...
    if (pathname == '/watch-store-worldmark-gurgaon') {
    }
                ...
                <div className="wowDtlsContent">
                  ...
                  <ul>
                    ...
                    <li className="callWithWatsapp">
                      <div className="whatsapp"><a target="_blank" href="https://wa.link/p36pih/">8448338685</a></div>
            ...
            <div className="col-lg-6 pe-lg-0">
              <div className="customOwlnav bottomPosition">
                <div className="owl-carousel topSlider owl-theme">
                  <div className="item">
                    <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/banner.jpg" className="w-100" />
                  </div>
                  <div className="item">
                    <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/banner2.webp" className="w-100" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="customOwlnav topLessPosition rightPostiont">
                <div className="owl-carousel brandSlider owl-theme">
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/brand1.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/brand2.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/brand3.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/brand4.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/brand5.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/brand6.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/brand7.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/brand8.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/brand9.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/brand10.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/brand11.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/brand12.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/brand13.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/brand14.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/brand15.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/brand16.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/brand17.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/brand18.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/brand19.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/brand20.webp" />
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="curveBg">
          <div className="customOwlnav bottomPosition">
            <div className="owl-carousel casioSlider owl-theme">
              <div className="item">
                <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/s1.webp" className="w-100" />
              </div>
              <div className="item">
                <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/s2.webp" className="w-100" />
              </div>
              <div className="item">
                <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/s3.webp" className="w-100" />
              </div>
              <div className="item">
                <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/s4.webp" className="w-100" />
              </div>
              <div className="item">
                <img src="https://bonwic.cloud/wow/watch-store-worldmark-gurgaon/img/s5.webp" className="w-100" />
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="modal-body">
              <div className="row">
                <div className="col-lg-6 pe-0 img-column">
                  <img src="https://bonwic.cloud/wow/assets-landing-page/img/model-worldmark.webp" className="img-fluid model-img" />
                </div>
