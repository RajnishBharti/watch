...
<img src='/images/watch-care-banner.png' />
 ...
 <section className="watchCareInfo  pt-5">
    <h2 className="h2 text-center underline text-center pb-3 mb-3">Our Watch Care</h2>
    <div className="container">
    <div className="row d-flex justify-content-center">
    <div className="col-lg-8">
    <p className={`normText  py-3 ${c.justifyContent} text-center`}>We know that you enjoy taking care of your watches just as much as you relish wearing them. 
		  			    ...
		  			    watchCareList.map((x, i)=>{
		  			        ...
		  			        <li>
        		  					...
        		  					<div className={c.captionText}>
        		  							<h2 className="h2 mb-0">{x.title}</h2>
        		  							<p className={`${c.tag} normText`}>{x.desc}</p>
