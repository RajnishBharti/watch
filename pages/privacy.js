...
const PrivacyPage = ({ data, error }) => {
  return (
    ...
    <h2 className="h2 text-center underline text-center pb-3 mb-3">Privacy Policy</h2>
  
    <p className="normText text-center">Our privacy policy is to make you aware of how we (World of Watches/WOW) use personal information collected through this website. Please read this privacy policy before using the site or submitting any personal information. By using the site, you accept the practices described in this privacy policy. These practices may be changed, but any changes will be posted and changes will only apply to activities and information going forward, not retroactive basis. You are encouraged to review the privacy policy whenever you visit the site to make sure that you understand how any personal information you provide will be used.</p>

<hr/>
       <p className="pt-0 mt-0"><strong>Note:</strong> The privacy practices outlined in this privacy policy are for this website only. If you link to other websites, please review the privacy policies posted at those sites.</p>
       <hr/>
...
<div className="termsCol">
              ...
              <p className="normText pb-2"><strong>We will use your personal information to:</strong></p>
              <ul>
...
<h2><span>Shipping Policy</span></h2>
  <div className="termsCol">
      <p className="normText">Once the order is confirmed, you will be receiving an email with the tracking link of your order. Alternatively, you can also call us at 0124 4225890 or Email us at wow.gurgaon@outlook.com to track your orders.</p>
  </div>
