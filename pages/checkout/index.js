    ...
    return (
      <div>
        <div className="row">
          <div className="col-md-6">
            <div className={classes.info}>
              ...
              <span>
                Address: {billingInfo.house}, {billingInfo.city},{" "}
          ...
          <div className="col-md-6">
            <div className={classes.info}>
              ...
              <span>
                Address: {shippingInfo.house}, {shippingInfo.city},{" "}
            ...
            <div className={classes.cart_item} key={index}>
              <div className={classes.cart_container}>
                ...
                <span className={classes.cart_disc}>
                  ...
                  <span>Price: {numberFormat(item.price)}</span>
                </span>
              </div>
            </div>
          ))}
        ...
        <div className={classes.price_description}>
          <span>Sub Total: {numberFormat(getTotalPrice)}</span>
