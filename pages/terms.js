  ...
  return (
    ...
    <div className="container">
      <div className="row flex-row-reverse">
        ...
        <h2 className="h2 text-center underline text-center pb-3 mb-3">Terms and conditions</h2>

         <p className="normText text-center">This use of World of Watches/WOW website and all the materials on this website are subject to the terms and conditions 
