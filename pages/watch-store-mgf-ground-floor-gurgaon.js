...
const Mgfground = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    date: '',
    time: '',
    subject: 'MGF Ground Floor - New Query',
  });
  ...
  useEffect(() => {
    ...
    if (pathname == '/watch-store-mgf-ground-floor-gurgaon') {
    }
                ...
                <div class="wowDtlsContent">
                  ...
                  <ul>
                    ...
                    <li class="callWithWatsapp">
                      <div class="whatsapp"><a target="_blank" href="https://wa.link/3zqs6r">8448338684</a></div>
            ...
            <div className="col-lg-6 pe-lg-0">
              <div className="customOwlnav bottomPosition">
                <div className="owl-carousel topSlider owl-theme">
                  <div className="item">
                    <img src="https://bonwic.cloud/wow/watch-store-mgf-ground-floor-gurgaon/img/banner.webp" className="w-100" />
                  </div>
                  <div className="item">
                    <img src="https://bonwic.cloud/wow/watch-store-mgf-ground-floor-gurgaon/img/banner2.webp" className="w-100" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="customOwlnav topLessPosition rightPostiont">
                <div className="owl-carousel brandSlider owl-theme">
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-mgf-ground-floor-gurgaon/img/brand1.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-mgf-ground-floor-gurgaon/img/brand2.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-mgf-ground-floor-gurgaon/img/brand3.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-mgf-ground-floor-gurgaon/img/brand4.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-mgf-ground-floor-gurgaon/img/brand5.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-mgf-ground-floor-gurgaon/img/brand6.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-mgf-ground-floor-gurgaon/img/brand7.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-mgf-ground-floor-gurgaon/img/brand8.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-mgf-ground-floor-gurgaon/img/brand9.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-mgf-ground-floor-gurgaon/img/brand10.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-mgf-ground-floor-gurgaon/img/brand11.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-mgf-ground-floor-gurgaon/img/brand12.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-mgf-ground-floor-gurgaon/img/brand13.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-mgf-ground-floor-gurgaon/img/brand14.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-mgf-ground-floor-gurgaon/img/brand15.webp" />
                  </div>
                  <div className="brandItmes">
                    <img src="https://bonwic.cloud/wow/watch-store-mgf-ground-floor-gurgaon/img/brand16.webp" />
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="curveBg">
          <div className="customOwlnav bottomPosition">
            <div className="owl-carousel casioSlider owl-theme">
              <div className="item">
                <img src="https://bonwic.cloud/wow/watch-store-mgf-ground-floor-gurgaon/img/s1.webp" className="w-100" />
              </div>
              <div className="item">
                <img src="https://bonwic.cloud/wow/watch-store-mgf-ground-floor-gurgaon/img/s2.webp" className="w-100" />
              </div>
              <div className="item">
                <img src="https://bonwic.cloud/wow/watch-store-mgf-ground-floor-gurgaon/img/s3.webp" className="w-100" />
              </div>
              <div className="item">
                <img src="https://bonwic.cloud/wow/watch-store-mgf-ground-floor-gurgaon/img/s4.webp" className="w-100" />
              </div>
              <div className="item">
                <img src="https://bonwic.cloud/wow/watch-store-mgf-ground-floor-gurgaon/img/s5.webp" className="w-100" />
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="modal-body">
              <div className="row">
                <div className="col-lg-6 pe-0 img-column">
                  <img src="https://bonwic.cloud/wow/watch-store-mgf-ground-floor-gurgaon/img/model-img.webp" className="img-fluid model-img" />
                </div>
