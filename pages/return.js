...
const ReturnPage = ({ data, error }) => {
  return (
   ...
   {/* <div class="row flex-row-reverse">
    ...
    <div class="row flex-row-reverse">
        <div class="col-xl-12 col-lg-8 col-md-8 col-sm-12">
    <h2 className="h2 text-center underline text-center pb-3 mb-3">Cancel and Return (Direct Online Purchases)</h2>
   

  <ul class="grid-list">

      <li>
      <h2 className="pb-3"><span>Exchange And Cancellation Policy</span></h2>
          <div class="termsCol">
            <ol>

              <li><p>To initiate cancellation of a product purchased directly from https://worldofwatchesindia.com/ the customer must rely on the order confirmation Email received from wow.gurgaon@outlook.com or contact our helpline number at +91-8448338684, Mon-Sat, 11 am – 8 pm, IST</p></li>
...
<h2 className="pb-3"><span>Exchange And Refund Policy</span></h2>
<br></br>
<div class="termsCol">
