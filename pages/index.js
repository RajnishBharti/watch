...
import HomeCatCard from '~/components/HomeCatCard/page'
import Connesiure from "~/components/HomeConnesiure/page";
import HomeTestimonials from "~/components/HomeTestimonials/page";
import HomeMarquee from "~/components/HomeMarquee/page";
    ...
    <>
      {error ? (
        ...
        <>
          ...
          <ProductList title="New Arrival" type="new" />          
          <Collection data={data.additional && data.additional.homePage.collection} />
          <ProductList title="Trending Watches" type="trending" />
          <HomeCatCard />
          <BrandCardList items={data.brand || []} />
          <WalkStore /> 
          <HomeMarquee />         
          <Connesiure banner={data.additional && data.additional.homePage.banner}  />
